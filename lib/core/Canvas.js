...
import { add, remove } from '../util/Collections';
...
Canvas.prototype.viewbox = function(box) {
  ...
  if (!box) {
    ...
    scale = round1000(matrix.a);

    x = round1000(-matrix.e || 0);
    y = round1000(-matrix.f || 0);
