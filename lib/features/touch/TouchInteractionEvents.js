...
import { toPoint, stopEvent } from '../../util/Event';
...
function createTouchRecognizer(node) {
  ...
  function stopMouse(event) {
    ...
    forEach(MOUSE_EVENTS, function(e) {
      domEvent.bind(node, e, stopMouseEvent, true);
    });
  }
  ...
  function allowMouse(event) {
    setTimeout(function() {
      forEach(MOUSE_EVENTS, function(e) {
        domEvent.unbind(node, e, stopMouseEvent, true);
      });
    }, 500);
  }
