...
const TOOLTIP_IDS = new IdGenerator('tt');

const TOOLTIP_CLS = 'djs-tooltip';
const TOOLTIP_SELECTOR = '.' + TOOLTIP_CLS;
...
export default function Tooltips(eventBus, canvas) {
  ...
  domDelegate.bind(this._tooltipRoot, TOOLTIP_SELECTOR, 'mousedown', function(event) {
    event.stopPropagation();
  });

  domDelegate.bind(this._tooltipRoot, TOOLTIP_SELECTOR, 'mouseover', function(event) {
    self.trigger('mouseover', event);
  });

  domDelegate.bind(this._tooltipRoot, TOOLTIP_SELECTOR, 'mouseout', function(event) {
...
Tooltips.prototype._addTooltip = function(tooltip) {
  ...
  htmlContainer = domify('<div data-tooltip-id="' + id + '" class="' + TOOLTIP_CLS + '" style="position: absolute">');
