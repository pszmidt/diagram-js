...
import { Event as LocalEvent } from '../../core/EventBus';

import { getLength, pointSubstract } from '../../util/Geometry';
...
export default function Dragging(eventBus, canvas, selection) {
  ...
  function fire(type, dragContext) {
    ...
    var event = assign(new LocalEvent(), dragContext.payload, dragContext.data);
  ...
  function move(event, activate) {
    ...
    var globalStart = context.globalStart,
        ...
        globalDelta = pointSubstract(globalCurrent, globalStart);

    var localStart = context.localStart,
        localCurrent = toLocalPoint(globalCurrent),
        localDelta = pointSubstract(localCurrent, localStart);
  ...
  function init(event, relativeTo, prefix, options) {
    ...
    context = assign({
      ...
      displacement: pointSubstract(relativeTo, localStart),
