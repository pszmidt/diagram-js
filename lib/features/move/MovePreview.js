...
const MARKER_OK = 'drop-ok';
const MARKER_NOT_OK = 'drop-not-ok';
const MARKER_NEW_PARENT = 'new-parent';
const MARKER_ATTACH = 'attach-ok';
...
export default function MovePreview(
  ...
  function getVisualDragShapes(shapes) {
    ...
    var filteredElements = withoutConnections(elements);
...
function withoutConnections(elements) {
